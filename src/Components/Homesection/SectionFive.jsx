...
import sdd from '../Images/sdd.svg'
                    ...
                    <div className='w-full relative bg-white p-10 rounded-2xl'>
                        <div className='flex items-center'>
                            <div className='w-20 h-20 p-2 bg-neutral-200 flex justify-center items-center rounded-full'>
                                <Image className='w-10 h-10' src={two} alt='' width={0} height={0}/>
                            </div>
                        ...
                        <Image className='absolute bottom-0 right-0 w-[16rem]' src={sdd} width={0} alt='' height={0}/>
                    </div>
