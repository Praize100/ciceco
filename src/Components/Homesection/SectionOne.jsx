...
import hero1 from '../Images/hero-right.png'
import hero2 from '../Images/hero-right-2.png'
import hero3 from '../Images/hero-right-3.png'
...
const SectionOne = () => {
  ...
  return (
    <div className='relative'>
        ...
        {showSectionOne === true &&
            <section className='px-[15rem] py-20 flex h-[100vh] bg-green-100 items-center '>
                <div className='w-[85%]' data-aos="fade-up" data-aos-duration="500">
                    ...
                    <h2 className='text-6xl font-bold leading-[60px] py-10'>Exclusive collection <br /> for everyone</h2>
      ...
      {/* ==================== SECTION TWO ================= */}
      {showSectionTwo === true &&
        <section className='px-[15rem] py-20 flex h-[80vh] bg-green-100 items-center '>
            ...
            <div className='ml-auto w-[100%]' data-aos="fade-up" data-aos-duration="500">
                <Image className='w-[100%]' src={hero2} alt='image' width={0} height={0}/>
            </div>
        </section>
        }
